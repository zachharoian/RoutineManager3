...
namespace App12
{
	public partial class RepeatNewViewController : UITableViewController
	{
		...
		bool neverDatePickerHidden = true;

		public RepeatNewViewController(IntPtr handle) : base(handle)
		{
