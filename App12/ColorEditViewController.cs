...
{
	public partial class ColorEditViewController : UITableViewController
	{
		public ColorEditViewController(IntPtr handle) : base(handle)
		{
		}

		public App12.EditEventController controller;
		...
		public override void RowSelected(UITableView tableView, NSIndexPath indexPath)
		{
			...
			if (App12.AgendaCell.GetColorName(controller.EventColor) == cell.TextLabel.Text)
			{
				...
				//	If the last cell was not White, unselect it and select White
				...
				{
					//	White shouldn't be able to be unselected if it was selected las
					cellWhite.Accessory = UITableViewCellAccessory.Checkmark;
